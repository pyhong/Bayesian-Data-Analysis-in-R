...
int main()
{
  ...
  int n = 1000, n1 = 500, p = 2, MCAX = 2000, GNUM = 1500;
...
//     printf_vector(wstar);
      ...
      gsl_matrix_get_col(Gam_col, Gam, j);
      tao[j] = 1 / gsl_ran_gamma(rr, 1 + (kk - 2) / 2, 1 / (0.00005 + txAx(Gam_col, M) / 2));
//     cout<<tao[j]<<endl;
//      cout<<txAx(Gam_col, M)<<" ";
...
//      printf_vector(Gam_col);
      ...
      gsl_vector_add_constant(Ycol, -6);
